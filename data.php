                    ...
                    <div class="leetcode-journey">
                        ...
                        <div class="leetcode-stats">
                            <div class="stat" data-target="50">
                                ...
                                <p class="count">50</p> <!-- Initially display target value -->
                            </div>
                            <div class="stat" data-target="30">
                                <h3>Medium Questions</h3>
                                <p class="count">30</p> <!-- Initially display target value -->
                            </div>
                            <div class="stat" data-target="10">
                                <h3>Hard Questions</h3>
                                <p class="count">10</p> <!-- Initially display target value -->
                            </div>
                        </div>
                    </div>
                </div>
